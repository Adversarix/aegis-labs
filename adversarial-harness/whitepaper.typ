...
#show: whitepaper.with(
  ...
  tiles: (
    ...
    ("10×", "Exploitation effort unlocked by the harness-enforced persistence loop"),
    ("100%", "Agent actions mediated and logged as first-class data"),
  ),
)
...
#callout("The question the harness answers")[
...
#table(
  columns: (2.1fr, 1.3fr, 1.5fr, 1.3fr, 1.2fr, 1fr, 1.1fr),
  align: (left, left, center, center, center, center, center),
  table.header(
    [*Model*], [*Where*], [*Genuine attempts*], [*Reached target*], [*Peak rounds*], [*Solved*], [*Denied*],
  ),
...
#callout("The decisive observation")[
...
#citation-block[The Adversarial Research Harness: Measuring Autonomous Offensive-Agent Capability Inside Enforced Containment]
